...
export default function ListaTurma({ id, nome, modulos, turmas, cargaHoraria, descricao }) {
                    ...
                    <div>
                        ...
                        >
                            ...
                            <form className='formEditar' onSubmit={editarturma}>
                                ...
                                <label htmlFor="">turma: <input type="text" name='nome' required value={edNome} onChange={e => setEdNome(e.target.value)} /></label>
